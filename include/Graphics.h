...
private:
    ...
    auto renderGameObjects(const std::vector<std::pair<TileType, SDL_Point>>& gameObjectsPositionsMap) -> void;
...
public:
    ...
    auto renderGrid(const std::vector<std::pair<TileType, SDL_Point>>& gameObjectsPositionsVector) -> void;
